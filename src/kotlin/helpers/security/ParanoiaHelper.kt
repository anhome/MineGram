...
object ParanoiaHelper {
    private val prefs by lazy {
        ApplicationLoader.applicationContext.getSharedPreferences("mintgram_hidden", Context.MODE_PRIVATE)
    }
    ...
    // opt-in: drop the Mintgram entry from stock Settings while armed
    @JvmStatic
