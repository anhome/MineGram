...
import desu.mintgram.ui.settings.PasscodeSettingsActivity
...
object PasscodeHelper {
    ...
    private val prefs by lazy {
        ApplicationLoader.applicationContext.getSharedPreferences("mintgram_passcode", Context.MODE_PRIVATE)
    }
